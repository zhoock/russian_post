            ...
            return (
                    <div>
                        ...
                        <div className="b-modal-overlay js-modal-overlay open">
                            ...
                            <div className="b-modal b-modal--set b-modal-effect-1">
                                        ...
                                        <form>
                                            <div className="row">
                                                <div className="small-11 columns small-centered">
                                                    ...
                                                    <div className="text-center"><a className="btn disabled btn--cart btn--expand"><i className="icon-shoppingcart"></i>В корзину<span className="price">932,18 &#8381;</span></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <section className="b-modal-content b-subscription">
                                    <div className="small-12 columns">
                                        <aside className="b-included b-included--popup">
                                            <h1>В комплекте</h1>
